...
function slider_jquery() {
 	wp_enqueue_script( 'slider', get_stylesheet_directory_uri() . '/js/slides.js', array('jquery') );
}
add_action( 'wp_enqueue_scripts', 'slider_jquery' );
...
function new_excerpt_more($more) {
       global $post;
    return '<a class="more-link" href="'. get_permalink($post->ID) . '">&nbsp;&nbsp;Читать дальше...</a>';
}
